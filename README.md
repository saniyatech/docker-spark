...
The image is built on top of OpenJDK (8-jdk). The 2.2.3 version of Apache Spark is installed in this image. Additionally, ssh has been installed and set-up to be executed password-less. For Apache Spark to be deployed in cluster mode, password-less ssh setup is mandatory.
...
[Dockerfile for Apache Spark v2.2.3](https://github.com/saniyatech/docker-spark/tree/v2.2.3)
